        ...
        <form enctype="multipart/form-data" class="form-horizontal" role="form" action="signup" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input
                            disabled
                            value="<c:if test='${profile.sex eq false}'>Male</c:if><c:if test='${profile.sex eq true}'>Female</c:if>" id ="sex" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input disabled value="${profile.quantityNeeded}" class="form-control" placeholder="Quanity needed" id="quantity_needed" name="quantity_needed">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="date_needed">Date needed</label>
                <div class="col-sm-10">
                    <input disabled value="${profile.dateNeeded}" class="form-control" placeholder="Date needed" id="date_needed" name="date_needed">
                </div>
            </div>
            <div class="form-group">
        ...
        <table>
            <tr>
                <td><img src="${pageContext.request.contextPath}/user/image?name=${profile.userName}" width="100%" height="180em">
                    <a><div class="form-control btn btn-danger">Inbox</div></a></td>
            </tr>
        </table>
    </div>
</div>